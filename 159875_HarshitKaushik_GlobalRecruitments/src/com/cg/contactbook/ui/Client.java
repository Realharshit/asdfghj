...
public class Client {
	public static void main(String[] args) throws SQLException {
		...
		case 2:
			...
			System.out.println("Id"+enquiryNo+" First Name "+enquiry.getfName()+" Last Name "+enquiry.getlName()+" Contact No "+enquiry.getContactNo()+" Preferred Domain "+enquiry.getpDomain()+" Preferred Location "+enquiry.getpLocation());
			break;
